...
class UserController(
    ...
    @PostMapping("/me2")
    fun me( @AuthenticationPrincipal authentication: Authentication?): ResponseEntity<String> {
        ...
        return ResponseEntity.ok("Hola $authentication 👋, estás autenticado.")
    }
 ...
 */
    ...
    fun getUserEntity(
        ...
        var userEntity: UserEntity =  this.userService.findByUsername(userAuth.username)
