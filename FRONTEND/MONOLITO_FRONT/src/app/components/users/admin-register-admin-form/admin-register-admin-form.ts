...
@Component({
  selector: 'app-admin-register-admin-form',
  standalone: false,
  templateUrl: './admin-register-admin-form.html',
  styleUrl: './admin-register-admin-form.scss'
})
export class AdminRegisterAdminForm {
  loginForm: FormGroup;
  ...
  onSubmit() {
    if (this.loginForm.valid) {
      ...
      this.userService.register_new_admin(userRegisterRequestDto).subscribe({
        next: (httpResponse) => {
